...
import gifUrlPastePlugin from './plugins/gifUrlPastePlugin';
import gifTitlePlugin from './plugins/gifTitlePlugin';
...
export default class ProseMirrorEditorDriver {
  ...
  buildPluginItems() {
    ...
    items.add('gifUrlPaste', gifUrlPastePlugin(this.schema));

    items.add('gifTitle', gifTitlePlugin(this.schema));
